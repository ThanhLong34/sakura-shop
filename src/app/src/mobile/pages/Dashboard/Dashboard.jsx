			...
			<div className={cx("wrapper")}>
				...
				<div className="card">
					...
					<p className={cx("note-text")}>
						Tất cả phần thưởng từ cửa hàng chỉ được phép đổi thưởng khi bạn mua hàng tại cửa hàng của chúng tôi.
						Bạn cần phải có đủ số sao hoặc kim cương để đổi thưởng.
					</p>
				</div>
				<div className="card">
