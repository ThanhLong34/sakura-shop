		...
		<div className={cx("dashboard")}>
			...
			<div className="card">
				...
				<p className={cx("note-text")}>
					Tất cả phần thưởng từ cửa hàng chỉ được phép đổi thưởng khi bạn mua hàng tại cửa hàng của chúng tôi. Bạn
					cần phải có đủ số sao hoặc kim cương để đổi thưởng.
				</p>
			</div>
			<div className="card">
					...
					<Link to="/classic-mode">
						<div className={cx("mode-item", "mb-3")}>
							...
							<div className={cx("mode-info")}>
								...
								<p className={cx("mode-desc")}>Trong chế độ này, người chơi được chọn 1 trong 3 cấp độ sau:</p>
								<ul>
									<li>Dễ: 12 thẻ bài</li>
